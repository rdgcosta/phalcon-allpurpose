...
if(
	...
	md5($_SERVER['PHP_AUTH_USER'] . 'HU3') !== md5('tcommerceuserHU3') ||
	md5($_SERVER['PHP_AUTH_PW'] . 'HU3') !== md5('tcommercepassHU3')
) {
...
if(isset($_POST['data']))
{
	...
	$headers = [
		'X-Ttoken' => 'TATKDD94315970267CE8A8BB9D94875618A2FFBD53D2',
